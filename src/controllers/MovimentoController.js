...
} from '../models/Movimentos.js';
import { dd, removeNull, removeUndefined } from './functions.js';

// class responsavel por todas acoes dos movimentos
class MovimentosController {
    ...
    * caso contrário irá exec
    * utar select, mas sem query, as respostas são as mesmas, o que muda é o filtro do status.
    */
...
export default MovimentosController;